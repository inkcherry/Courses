...
<myTemplate:template>
	<jsp:body>
		...
		<thead>
           ...
           <td><a class="btn btn-primary" href="admin/course/${i.id }/addexp" role="button">添加实验</a>
           		<a class="btn btn-primary" href="admin/downloadzip/${i.id }-${i.name}/" role="button">下载</a>
           </td>
			</tr>
			</c:forEach>
			</tbody>
