...
<!--[if lte IE 8]>
<script>
windows.alert('检测到您使用的是IE8或以下版本浏览器，将无法正常使用本系统功能'); 
</script>
<div class="ie_alert">
...
<![endif]-->
	...
	<div class="logindiv">
		<!-- 按钮触发模态框 -->
		<button class="btn btn-lg btn-info btn-block" data-toggle="modal" data-target="#myModal">专业课程管理</button>
		<a href="https://github.com/bwhyman/SEWM" target="_blank">
			<img id="github" alt="github" src="resources/images/gh-project.png"></a>
	</div>
			...
			<div class="modal-content" >
				...
				<div id="ilogin" hidden="">
					<form class="form-signin" action="ilogin" method="post">
						<button class="btn btn-lg btn-primary btn-block" type="submit">${msg }，登录</button>
						<!-- <a id="relogin">重新登录</a> -->
				...
				<div id="login" hidden="">
				<div class="text-info">用户名与密码均为学号</div>
					<form class="form-signin" action="login" method="post">
						<div class="input-group ">
							<label for="employeeNumber" class="sr-only">学号</label>
